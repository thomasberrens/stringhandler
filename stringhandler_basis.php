	 ...
	 <body>
		...
		<div class="wrapper">
			...
			?><ul>				
					...
					<li>De lengte van string3 is:  <?php   echo strlen($string3) ?> </li>
					...
					<li class="showSpaces">Wijzig de eerste letter van string 3 naar hoofdletter:  <?php echo ucfirst($string3); ?> </li>
					<li class="showSpaces">Alles in hoofdletters: <?php  echo strtoupper($string3);   ?> </li>
